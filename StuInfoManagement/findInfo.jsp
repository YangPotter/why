			...
			<div class="row">
				<div id="showmain" class="col-md-8">
					<div class="row">
						...
						<div class="col-md-8">
							<h1 class="page-header text-center">学生信息查询</h1>
						</div>
						<div class="col-md-2">
							
						</div>
					</div>
					<form action="Select" method="post" class="form-horizontal">
				...
				<div class="col-md-4 sidbar-offcanvas">
					...
					<div style="background: white;">
						<ul class="nav nav-pills nav-stacked">
							...
							<li role="presentation" class="active"><a href="findInfo.jsp">学生信息查询</a></li>
